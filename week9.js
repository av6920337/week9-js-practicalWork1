...
console.log('Добро '+ 'пожаловать, ' + 'Alice');
...
let wikipedia = 137;
let youTube = 201;
let resultHours = ((messenger + likeFotos + wikipedia + youTube) / 60);
let resultMinutes = ((messenger + likeFotos + wikipedia + youTube) % 60); 
console.log(`Русалка прокрастинировала ${resultHours} часов и ${resultMinutes} минут.`);

//Задание 9
//Зарплата вечернего уборщика в городской поликлинике 40 000 рублей, а педагога по вокалу 22 000 рублей. Выведи в консоль, сколько можеn зарабатывать вечерний уборщик, имея голос и педагогическое образование?
let salaryCleaner = 40000;
let salaryVocalTeacher = 22000;
let totalSalary = salaryCleaner + salaryVocalTeacher;
console.log(`Bечерний уборщик, имея голос и педагогическое образование можеn зарабатывать ${totalSalary} рублей.`)
